# Generated by Django 5.1 on 2024-08-14 02:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('id', models.CharField(default='bDeJCZFcLZKOqBJ', editable=False, max_length=15, primary_key=True, serialize=False, unique=True)),
