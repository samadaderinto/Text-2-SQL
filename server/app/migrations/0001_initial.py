# Generated by Django 3.2.25 on 2024-08-10 02:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('id', models.CharField(default='5B3fIWGs4p7OiJj', editable=False, max_length=15, primary_key=True, serialize=False, unique=True)),
